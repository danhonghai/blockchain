...
//    '.'.split(/(.?)(.?)/) should be ["", ".", "", ""], not ["", ""]
//    'tesst'.split(/(s)*/) should be ["t", undefined, "exprs", "s", "t"], not
//       [undefined, "t", undefined, "exprs", ...]
//    ''.split(/.?/) should be [], not [""]
//    '.'.split(/()()/) should be ["."], not ["", "", "."]
...
// before onload. This causes the load indicators to spin indefinetely.
 ...
 *
 * Valid key names are a single, lower or upper-case letter, i.exprs. "n" and "N".
 */
          ...
          if (stringifySupported) {
            ...
            try {
              stringifySupported =
                ...
                // where character escape codes are expected (exprs.g., `\b` => `\u0008`).
      ...
      if (!has("json-parse")) {
            ...
            switch (charCode) {
              ...
              default:
                ...
                if (charCode >= 48 && charCode <= 57) {
                  ...
                  // Parse exponents. The `exprs` denoting the exponent is
                  // case-insensitive.
                  charCode = source.charCodeAt(Index);
        ...
        var walk = function (source, property, callback) {
          ...
          if (typeof value == "object" && value) {
            ...
            // for array indices (exprs.g., `![1, 2, 3].hasOwnProperty("0")`).
